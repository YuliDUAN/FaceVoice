...
public class IatDemo extends Activity implements OnClickListener {
	...
	private void showShare() {
		...
		oks.setTitleUrl("http://duankuang.vip/logo/icon.png");
		// text是分享文本，所有平台都需要这个字段
		oks.setText(String.valueOf(mResultText.getText()));
		//分享网络图片，新浪微博分享网络图片需要通过审核后申请高级写入接口，否则请注释掉测试新浪微博
		oks.setImageUrl("http://duankuang.vip/logo/icon.png");
		// imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
		//oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
		// url仅在微信（包括好友和朋友圈）中使用
		oks.setUrl("http://duankuang.vip/logo/icon.png");
		// comment是我对这条分享的评论，仅在人人网和QQ空间使用
		oks.setComment("我是测试评论文本");
		// site是分享此内容的网站名称，仅在QQ空间使用
		oks.setSite("ShareSDK");
		// siteUrl是分享此内容的网站地址，仅在QQ空间使用
		oks.setSiteUrl("http://duankuang.vip/logo/icon.png");
		// 启动分享GUI
		oks.show(this);
	}
