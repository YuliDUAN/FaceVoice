...
public class WeaDemo extends Activity implements View.OnClickListener{

	private static String TAG = WeaDemo.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.weademo);
		initLayout();
