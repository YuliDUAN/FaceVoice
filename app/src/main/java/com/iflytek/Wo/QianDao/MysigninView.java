...
public class MysigninView extends View{
    ...
    private void init() {
        ...
        mTextNumberPaint.setTextSize(CalcUtils.sp2px(getContext(), 15f));

        //已经完成的icon
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.signed);
        //正在进行的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.unsigned);
        //未完成的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.unsigned);
        //UP的icon
        mUpIcon = ContextCompat.getDrawable(getContext(), R.drawable.up);
    }
